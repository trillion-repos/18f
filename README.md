...
SSL certificates are used for providing secure access to the ODV Platform. Through AWS VPC we created DMZ. The VPC DMZ allow only 443 throught Apache to connect to ODV Platform. 
