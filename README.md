...
SSL certificates are used for providing secure access to the ODV Platform. We used Amazon Virtual Private Cloud(VPC) PaaS services to created Web DMZ Zone Architecture. The VPC DMZ allows only 443 through Apache to connect to ODV Platform.
